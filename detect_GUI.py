...
root.title("Face Mask Detction Lite")
...
def btn1():
        ...
        while True:
                ...
                for (box, pred) in zip(locs, preds):
                        ...
                        if(label == 'No Mask'):
                                winsound.PlaySound('alarm_once.wav', winsound.SND_ASYNC)
...
b1 = Button(root, fg="white", height=1, width=18, bg="black", font="bold", borderwidth=5, text="Use Internal Camera", command=btn1)
...
b1 = Button(root, fg="white", height=1, width=18, bg="black", font="bold", borderwidth=5, text="Use External Camera", command=btn2)
